function [case1_confusion, case2_confusion] = KNN_error_analysis(X1,X2,Y1,Y2,Z1,Z2)
    global classA_test classB_test classC_test classD_test classE_test class_tests;
    
classA_data_mapped = classify_data_KNN(classA_test, X1, Y1, Z1);
classB_data_mapped = classify_data_KNN(classB_test, X1, Y1, Z1);
classC_data_mapped = classify_data_KNN(classC_test, X2, Y2, Z2);
classD_data_mapped = classify_data_KNN(classD_test, X2, Y2, Z2);
classE_data_mapped = classify_data_KNN(classE_test, X2, Y2, Z2);
